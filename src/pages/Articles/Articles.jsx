  ...
  return (
    <>
      <p className={`paragrafo ${styles.p}`}>
        ...
        em Computação e TIC definidos pela comunidade de pesquisa nessas áreas.
      </p>
      <ul className={styles.articleList}>
      ...
      <ul className={styles.articleList}>
        ...
        <li className={styles.ulLi}>
          ...
          processos, modelagem de processos, social BPM, processos intensivos em
          conhecimento, adaptação de processos, processos sensíveis a contexto);
        </li>
        ...
        <li className={styles.ulLi}>
          Representação de informações de negócio, gerência de dados e metadados
          nas organizações, ontologias;
        </li>
        <li className={styles.ulLi}>
          SI/TIC para governo (transparência, dados abertos, interoperabilidade,
...
function SubmissionInstructions() {
  return (
    <>
      <p className={`paragrafo ${styles.p}`}>
        Os artigos podem ser submetidos para o V SERCOMP somente nas categorias
        “relatos de caso” (case reports), sobre projetos em desenvolvimento, e
        &ldquo;artigo completo&ldquo; (full paper) sobre trabalhos de pesquisas
        já concluídas, com ideias e resultados inovadores, e seguindo
      ...
      <ul className={styles.articleList}>
        <li className={styles.ulLi}>
          Sugere-se que os artigos descrevem claramente a metodologia científica
          empregada e uma análise dos resultados, ressaltando as contribuições
          de pesquisa e inovação em Computação e para a área de aplicação,
          posicionando-a em relação a outros trabalhos da área;
        </li>
        <li className={styles.ulLi}>
          Todos os artigos podem ser submetidos em Português ou Inglês, em
          formato PDF e seguindo o modelo para publicação de artigos da SBC. As
          submissões devem ser feitas por meio do formulário
        </li>
        <li className={styles.ulLi}>
        ...
        <li className={styles.ulLi}>
          Os trabalhos submetidos não devem ter sido publicados e nem estarem em
        ...
        <li className={styles.ulLi}>
          ...
          referência que identifique a proveniência do artigo deve ser removida
          da versão de submissão, como nome de projetos, de instituições, de
          ferramentas e citações de artigos que identifiquem os autores. Artigos
          que possuírem identificação nesta etapa serão rejeitados. Caso o
          artigo seja aceito, os autores deverão incluir na versão final seus
          dados (nomes, filiações e e-mails, bem como demais informações
          necessárias ao artigo, a exemplo de citações a outros trabalhos dos
          autores);
        </li>
        <li className={styles.ulLi}>
          A seleção de trabalhos será realizada a partir da revisão por membros
          do Comitê de Programa do V SERCOMP. O processo de revisão será
          conduzido de forma duplamente anônima (double-blind review) por, pelo
          menos, dois revisores;
        </li>
        <li className={styles.ulLi}>
...
function Publication() {
  return (
    <>
      <p className={`paragrafo ${styles.p}`}>
        Os artigos aceitos serão publicados nos anais do evento, condicionados à
        inscrição, de, pelo menos, um dos autores no evento, bem como à
